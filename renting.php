...
?> 
    	<div id="featured_project2">Rent your property</div>
    <div style="clear:both; color: #555555;" id="featured_project_content2">    
    <form id="form1" name="form1" method="post" action="">
    
      <table width="100%" height="559" align="center" cellspacing="2">
        <tr>
        ...
        <tr>
          ...
          <td><p>
            <label>
              <input type="radio" name="rdogrplistingtype" value="Fast Response" id="rdogrplistingtype" />
	...
	?>
            <select name="prop_type" id="prop_type" style="200px;">
              <?php 
	 for($i=1;$i<$nprop;$i++)
     {
	...
	?>
        ...
        <tr>
          ...
          <td><p>
            <input name="txtminarea" type="text" id="txtminarea" size="25" style="200px;" />
            (Minimum Area)</p>
            <p>
              <input name="txtmaxarea" type="text" id="txtmaxarea" size="25" style="200px;" />
              (Maximum Area)</p></td>
        </tr>
        <tr>
          <td height="32"><span id="s">Rent Price (<span class="WebRupee">Rs.</span> )   (Approx.)</span></td>
          <td><input name="txtrent_price" type="text" id="txtrent_price" size="25"  style="200px;"/></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><select name="min_ddlbedrooms" id="min_ddlbedrooms" style="200px;">
            ...
            <select name="max_ddlbedrooms" id="max_ddlbedrooms" style="200px;">
      ...
      <table width="709" height="504" align="center" cellspacing="2">
        <tr>
          <td width="237"><span id="s13">Bathrooms</span></td>
          <td width="460"><select name="ddlbathroom" id="ddlbathroom" style="200px;">
            <option selected="selected" value=''>-Number of Bathroom-</option>
        ...
        <tr>
          <td height="35" colspan="2">&nbsp;Upload property image &nbsp;&nbsp;&nbsp;&nbsp;
            <input name="fileupload" type="file" id="fileupload" size="45" style="200px" /></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
